...
DOMTestCase('HTMLTableElement08') do
  ...
  def test_HTMLTableElement08
    ...
    doc = load_document("table", false)
      ...
      indexid36159162 = 0
    while (indexid36159162 < tbodiesnodeList.length)
      vtbodies = tbodiesnodeList.item(indexid36159162)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableElement08"
  end
end
