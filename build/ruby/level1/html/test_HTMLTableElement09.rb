...
DOMTestCase('HTMLTableElement09') do
  ...
  def test_HTMLTableElement09
    ...
    doc = load_document("table", false)
      ...
      indexid36114970 = 0
    while (indexid36114970 < tbodiesnodeList.length)
      vtbodies = tbodiesnodeList.item(indexid36114970)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLTableElement09"
  end
end
