...
DOMTestCase('anchor04') do
  ...
  def test_anchor04
    ...
    doc = load_document("anchor", false)
      ...
      vhref = testNode.href()
      assertURIEquals("hrefLink", nil, nil, nil, "submit.gif", nil, nil, nil, Boolean.TRUE, vhref)
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/anchor04"
  end
end
