...
DOMTestCase('object05') do
  ...
  def test_object05
    ...
    doc = load_document("object", false)
      ...
      assert_equal("http://xw2k.sdct.itl.nist.gov/brady/dom/", vcodebase, "codebaseLink")
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/object05"
  end
end
