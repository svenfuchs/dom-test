...
DOMTestCase('HTMLCollection04') do
  ...
  def test_HTMLCollection04
    ...
    expectedResult = []
      expectedResult << new Integer(4)
      expectedResult << new Integer(5)
    ...
    doc = load_document("collection", true)
      ...
      result << new Integer(rowLength1))
      newRow = testNode.insertRow(4)
      rowLength2 = rowsnodeList.length()
      result << new Integer(rowLength2))
  ...
  #
  def targetURI
    "http://www.w3.org/2001/DOM-Test-Suite/tests/Level-1/HTMLCollection04"
  end
end
