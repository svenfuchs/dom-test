...
DOMTestCase('hc_nodeclonenodetrue') do
  ...
  def test_hc_nodeclonenodetrue
    ...
    doc = load_document("hc_staff", true)
      ...
      indexid36043213 = 0
    while (indexid36043213 < origList.length)
      origChild = origList.item(indexid36043213)
    origChildName = origChild.nodeName()
      ...
      indexid36036570 = 0
    while (indexid36036570 < clonedList.length)
      clonedChild = clonedList.item(indexid36036570)
